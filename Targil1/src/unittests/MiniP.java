...
public class MiniP {
    ...
    public void Bear()
    {
    	...
    	Camera camera = new Camera(new Point3D(-122, -105, -1000), new Vector(1, 0, 1), new Vector(0,1, 0)) //
		...
		new Polygon(new Point3D(-182,-145,0),new Point3D(-132,-145,0),new Point3D(-32,-145,-186),new Point3D(-182,-145,-186)
