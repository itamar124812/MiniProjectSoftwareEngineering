  ...
  @Test
    public void scene1DepthOfFieldTest() {
        ...
        scene.geometries.add(new ArrayList<Intersectable>(List.of(              
         table.getTableParts(), new Plane(new Point3D(0,120,0),new Vector(0,1,0)),
                new Plane( new Point3D(103, -10, -130),new Vector(0,-0.15,1)).setMaterial(new Material().setkD(0.2).setks(0.2).setKt(0.4).setKr(0).setnShininess(10)).setEmmission(new Color(30,30,30)),
        ...
        scene.lights.add(new PointLight(new Color(150, 200, 200),
                new Point3D(0, -200, -200) ).setkC(1).setkL(4E-4).setkQ(2E-5));

        scene.lights.add( new SpotLight(new Color(180,180,120),
                new Point3D(0, -200, -200),new Vector(40,213.5,135)).setkC(1).setkL(4E-4).setkQ(2E-5));
        scene.lights.add( new SpotLight(new Color(110,110,80),
                new Point3D(45, -126.5, -349),new Vector(0,1,0.1).normalize()).setkC(1).setkL(4E-4).setkQ(2E-5));



        ImageWriter imageWriter = new ImageWriter("scene1DepthOfFieldTest", 500, 500);
        Render render = new Render().setCamera(new Camera(new Point3D(40, -10, -700), new Vector(0, 0, 1), new Vector(0, -1, 0)).setViewPlaneSize(200, 200))
               .setRayTracerBasic(new RayTracerBasic(scene)) .setImageWriter(imageWriter).setMultithreading(3).setDebugPrint();
...
/*
    ...
    public void scene1DepthOfFieldAndAdaptiveSuperSamplingTest() {
        ...
        scene.lights.add( new SpotLight(new Color(180,180,120),
                new Point3D(0, -200, -200),new Vector(40,213.5,135)));
                scene.lights.add( new SpotLight(new Color(110,110,80),
                new Point3D(45, -126.5, -349),new Vector(0,1,0.1).normalize()));



        ImageWriter imageWriter = new ImageWriter("scene1DepthOfFieldTestAdaptiveSuperSampling",  500, 500);
        Render render = new Render().setImageWriter(imageWriter).setCamera(new Camera(new Point3D(40, -10, -700), new Vector(0, 0, 1), new Vector(0, -1, 0)))
    ...
    public void mini_project2_light() {
       ...
       scene.addGeometries(floor.getFloorParts());
        ...
        scene.setLights(lamp1.getLightLamp());
        ...
        scene.setLights(lamp2.getLightLamp());
        ...
        scene.setLights(lamp3.getLightLamp());


        scene.setLights( new SpotLight(new Color(110,110,80),
                new Point3D(45, -50, -349),new Vector(0,1,0.7).normalize(),1, 4E-4, 2E-5));
        scene.setLights(new DirectionalLight(new Color(50,50,50),new Vector(-0.4, 0, 0.7).normalize()));
        scene.setLights(new DirectionalLight(new Color(100,100,100),new Vector(0.2,0,0.2).normalize()));
